    ...
    <div class="sg-page-demo ExampleFormSlot">
        <el-card class="my-card">
            ...
            <section class="sg-card-body">
                ...
                >
                    <!-- gender slot -->
                    <el-button slot="gender-appendSlot" style="margin-left:10px"
                        >测试</el-button
                    >
                    <!-- 内容slot -->
                    <el-select
                        v-model="FormView.model.select"
                        slot="content-prepend"
                        placeholder="请选择"
                        style="width:120px"
                    >
                    ...
                    <!-- 验证码slot -->
                    <i class="el-icon-user" slot="smscode-prefix"></i>
                    <div slot="smscode-appendSlot" style="margin-left:12px;">
                    ...
                    <div slot="shop-autocomplete-slot" slot-scope="{ item }">
                        ...
                        <span class="addr" style="font-size:12px;color:gray">{{
                            item.address
                        }}</span>
                    </div>
                </sg-base-form>
                    ...
                    },
                    {
                        ...
                        attrs: {
                            ...
                            inputSlots: [
                                {
                                    slotType: 'prepend',
                                    slotName: 'content-prepend',
                                },
                                {
                                    slotType: 'append',
                                    slotName: 'content-append',
                                },
                            ],
                            placeholder: '请输入内容',
                        },
                    },
                    {
                        ...
                        attrs: {
                            ...
                            inputSlots: [
                                {
                                    slotType: 'prefix',
                                    slotName: 'smscode-prefix',
                                },
                            ],
                            appendSlot: 'smscode-appendSlot',
                            placeholder: '请输入验证码',
                        },
                    },
