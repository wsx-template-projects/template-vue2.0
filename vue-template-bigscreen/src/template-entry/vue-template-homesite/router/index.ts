...
const createRouter = function(): any {
 ...
 */
export const resetRoutes = function(newRoutes: any) {
 ...
 * @returns {routes}
 */
export const filterMapRoutes = function(filterCallback: any) {
...
/* 初始化公共路由 */
resetRoutes(
    filterMapRoutes((meta: any) => {
        return meta.requireAuth === undefined || meta.requireAuth === false // 如何处理路由权限因项目而异...
    }),
)
